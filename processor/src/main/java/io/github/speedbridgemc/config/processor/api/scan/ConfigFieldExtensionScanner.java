...
public abstract class ConfigFieldExtensionScanner extends Scanner {
    protected ConfigFieldExtensionScanner(@NotNull String id) {
        super(id);
    }

    public interface Callback {
        void addExtension(@NotNull ConfigFieldExtension ext);
    }
